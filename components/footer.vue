      ...
      <div class="footer-bottom-container">
        ...
        <div class="footer-links">
          <div class="footer-container1">
            ...
            <span class="footer-text08 footer-link">Workshops</span>
          </div>
          <div class="footer-container2">
            ...
            <span class="footer-text16 footer-link">sales</span>
          </div>
        </div>
      </div>
      <div class="footer-copyright">
        <span class="footer-text17">
          <span>
            <span>
              © All rights reserved
              <span v-html="raw0vx6"></span>
            </span>
            <span><span v-html="rawhcql"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              Powered by
              <span v-html="rawjjm3"></span>
            </span>
            <span><span v-html="raw54rm"></span></span>
          </span>
          <a
          ...
          <span>
            <span>
              . Image source:
              <span v-html="rawqbz7"></span>
            </span>
            <span><span v-html="rawvfaf"></span></span>
          </span>
          <a
            ...
            rel="noreferrer noopener"
          >
            <span class="footer-text29">Unsplash</span>
          </a>
          <span>.</span>
        </span>
      </div>
