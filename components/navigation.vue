      ...
      <div data-role="MobileMenu" class="mobile-menu">
        <div class="navigation-nav1">
          <div class="navigation-container">
            <img :alt="image_alt1" :src="image_src1" />
            <div data-role="CloseMobileMenu" class="navigation-close-mobile-menu">
          ...
          ></navigation-links>
          <button class="button-secondary button button-md">{{ button2 }}</button>
        </div>
      </div>
    </div>
  </header>
...
export default {
  ...
  props: {
    ...
    image_src1: {
      type: String,
      default: '/playground_assets/logo1-1500h.png',
    },
    button2: {
      type: String,
      default: 'Get in touch',
